...
" flake8 formatting and code styl
...
"     deleting buffer w/o closing it
...
imap <silent> <C-ü> <Plug>(copilot-dismiss)
...
" let g:ycm_python_binary_path = '/home/lmahler/miniconda3/bin/python3'
...
nmap <leader>t :call Termfunc()<cr>
...
autocmd FileType py inoremap <pdb import pdb; pdb.set_trace()Enter>    
